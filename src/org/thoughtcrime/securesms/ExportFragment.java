...
public class ExportFragment extends Fragment {
  ...
  private void handleExportEncryptedBackup() {
    ...
    builder.setTitle("ExportFragment_export_to_sd_card");
    builder.setMessage("ExportFragment_this_will_export_your_encrypted_keys_settings_and_messages");
  ...
  private class ExportEncryptedTask extends AsyncTask<Void, Void, Integer> {
    ...
    protected void onPreExecute() {
      dialog = ProgressDialog.show(getActivity(),
                                   getActivity().getString(R.string.ExportFragment_exporting),
                                   "ExportFragment_exporting_keys_settings_and_messages",
                                   true, false);
    }
